    ...
    switch ((_a = cmd.args[0]) !== null && _a !== void 0 ? _a : command_1.Command.extractCommand(cmd.msg.content)) {
        ...
        case "theo":
            var urls = [
                ...
                "https://media.discordapp.net/attachments/775053426790629386/816371679311036436/Screenshot_2021-02-12-14-43-58-67.png"
            ];
            cmd.msg.channel.send(new discord_js_1.MessageEmbed({ image: { url: urls[Math.floor(Math.random() * urls.length)] } }));
            break;
        default:
