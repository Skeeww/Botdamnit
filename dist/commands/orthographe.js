...
function run(cmd) {
    if ((cmd.args.join(" ") || "").length < 20) {
        jimp_1.default.read("./src/assets/orthmonkey.png").then(function (img) {
            jimp_1.default.loadFont(font).then(function (f) {
                img.print(f, 59, 40, {
                    ...
                    v.getBuffer(jimp_1.default.MIME_PNG, function (err, v) {
                        ...
                        cmd.msg.channel.send(new discord_js_1.MessageAttachment(v, 'orthograf.png'));
                    });
                });
            });
        }).catch(function (err) {
...
exports.run = run;
//# sourceMappingURL=orthographe.js.map